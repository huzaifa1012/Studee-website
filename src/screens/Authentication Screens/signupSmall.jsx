...
import VerificationSmall from "./verificationSmall";
const RegisterSmall = () => {
    ...
    return (
        <>
            {verification ? (
                <>
                    <VerificationSmall data={data} />
                </>
            ) :
                <div className="login_container_wrap" style={{ background: 'none', }}>
                    <div className="login_container" >
                        <div className="login_form" style={{ width: '100%', boxShadow: 'none', paddingTop: '0px' }}>
                            <h2>Create your free account</h2>
                            <p>
                                Just enter a few details and we'll create your free account.
