      ...
      <div className='why_use_main_wrap'>
        ...
        <div className='why_use_bottom_wrap'>
          <div className='why_use_bottom'>
            <p style={{ color: 'green', backgroundColor: 'rgba(0, 87, 0, 0.100)', fontSize: '17px', padding: '10px 10px', borderRadius: '7px', margin: '15px 0px', display: 'inline-block',width: '100%' }}> <b> Carbon compensation </b> - We'll plant trees in your name to compensate for the carbon generated by all your flights to and from university.</p>
            <p style={{ color: '#2b2d4a', backgroundColor: '#cdcdff40', fontSize: '17px', padding: '10px 10px', borderRadius: '7px', margin: '15px 0px', marginBottom:'30px', display: 'inline-block', width: '100%' }}>All our services are 100% free as we're funded by universities. You pay deposits & tuition fees directly to the university.</p>
            <p style={{marginBottom:'40px'}}>* Price based on similar application assessment services from other providers</p>
