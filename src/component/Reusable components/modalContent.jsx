...
export default function VerticalTabs() {
  ...
  return (
    ...
    >
      <div className="filt_modal_main">
        <div className="filt_modal_top">
          <Tabs
          ...
          {/* 1 */}
          <TabPanel value={value} index={0} className="each-tab-panel">
                    ...
                    <div class="modal_checkBox_wrap">
                      <div class="modal_checkBox_body">
                        <input
                          ...
                          name="undergraduate"
                        />{" "}
                        <span className="m-checkbox-text">up to 3 year</span>
                      </div>
                    </div>
                  </label>
                  <label>
                    <div class="modal_checkBox_wrap">
                      <div class="modal_checkBox_body">
                        <input
                          ...
                          name="undergraduate"
                        />{" "}
                        <span className="m-checkbox-text">Up to 4 year</span>
                      </div>
                    </div>
                  </label>
                </div>
